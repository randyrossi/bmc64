...
* **Performance on older Raspberry Pi models is a priority.** BMC64 aims to provide fast and responsive emulation on the older and lower-powered Raspberry Pi models it supports. This may sometimes take priority over improvements in emulation accuracy. BMC64 uses the VICE x64 emulation core not the x64sc core, which can affect compatibility.
