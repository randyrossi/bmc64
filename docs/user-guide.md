...
This guide covers installing, configuring, and using BMC64, including machine selection, video and timing, files and drives, input devices, networking, and common questions.

[Back to BMC64 project overview](../README.md)

## Contents

- [BMC64 User Guide](#bmc64-user-guide)
  - [Contents](#contents)
...
- [Video \& Timing](#video--timing)
  - [machines.txt](#machinestxt)
    ...
    - [DPI (Parallel Display Interface)](#dpi-parallel-display-interface)
  - [Recovering from a Blank Screen](#recovering-from-a-blank-screen)
  - [Video + Timing (VIC20, C128, Plus/4, PET)](#video--timing-vic20-c128-plus4-pet)
  - [Dimensions and Scaling](#dimensions-and-scaling)
    - [Integer Scaling](#integer-scaling)
    - [Perfect DPI -\> (Real) CRT Scanlines](#perfect-dpi---real-crt-scanlines)
  - [VGA Display without 15khz hsync support](#vga-display-without-15khz-hsync-support)
  - [Video Scaling Algorithm](#video-scaling-algorithm)
  - [(Real) CRT Scanline alignment](#real-crt-scanline-alignment)
  - [CRT Filter](#crt-filter)
    - [CRT Filter + Performance](#crt-filter--performance)
...
- [Input \& GPIO](#input--gpio)
  ...
  - [Joyport Configuration](#joyport-configuration)
  - [USB Button / Hotkey Function Mapping](#usb-button--hotkey-function-mapping)
  - [GPIO Configurations](#gpio-configurations)
    - [BMC64 PCBs for Original C64 Cases](#bmc64-pcbs-for-original-c64-cases)
    - [GPIO Config 1 : Menu Nav Buttons and Joysticks](#gpio-config-1--menu-nav-buttons-and-joysticks)
    - [GPIO Config 2 : GPIO Keyboard and Joysticks](#gpio-config-2--gpio-keyboard-and-joysticks)
...
1. `.DHD` files can be slow to attach and parse from SDCards.  Try to use a USB thumbstick if you have performance issues.
...
From v5.0.0 and onwards gamepad support has been greatly improved

List of gamepads and adapters tested:

  * 8BitDo USB Wireless Adapter 2 (allow connecting almost any bluetooth gamepad)
  * 8BitDo Ultimate C 2.4G Wireless Controller
  * 8BitDo Pro 3 Bluetooth Gamepad
  * 8BitDo Ultimate 2.4G Controller
  * 8bitDo M30 2.4G for SEGA Genesis & Mega Drive
  * Generic SNES style USB gamepad
  * Xbox 360 PC Wireless Receiver (and compatible clones)

If your gamepad doesn't work drop create an issue, and we can see if we can get it working.

Known gamepads now have a default binding configuration. Using "Reset to Default Bindings" can be used to revert to default bindings.
