...
static long kbdMatrixKeyCodes[8][11] = {
 {KEYCODE_Backspace,  KEYCODE_3,         KEYCODE_5, KEYCODE_7, KEYCODE_9, KEYCODE_Left,         KEYCODE_Up,           KEYCODE_1,		KEYCODE_128Help, 		KEYCODE_128Escape, 	KEYCODE_128Alt},
 {KEYCODE_Return,     KEYCODE_w,         KEYCODE_r, KEYCODE_y, KEYCODE_i, KEYCODE_p,            KEYCODE_Dash,         KEYCODE_BackQuote,	KEYCODE_KP8,			KEYCODE_KP_Add,		KEYCODE_KP0},
 {KEYCODE_BackSlash,  KEYCODE_a,         KEYCODE_d, KEYCODE_g, KEYCODE_j, KEYCODE_l,            KEYCODE_SingleQuote,  KEYCODE_Tab,		KEYCODE_KP5, 			KEYCODE_KP_Subtract, 	KEYCODE_KP_Decimal},
 {KEYCODE_F7,         KEYCODE_4,         KEYCODE_6, KEYCODE_8, KEYCODE_0, KEYCODE_Right,        KEYCODE_Down,         KEYCODE_2,		KEYCODE_128Tab,			KEYCODE_128LineFeed, 	KEYCODE_Up},
 ...
 {KEYCODE_F3,         KEYCODE_s,         KEYCODE_f, KEYCODE_h, KEYCODE_k, KEYCODE_SemiColon,    KEYCODE_RightBracket, KEYCODE_LeftControl,	KEYCODE_KP4, 			KEYCODE_KP6, 		KEYCODE_Left},
 {KEYCODE_F5,         KEYCODE_e,         KEYCODE_t, KEYCODE_u, KEYCODE_o, KEYCODE_LeftBracket,  KEYCODE_Equals,       KEYCODE_q,		KEYCODE_KP7, 			KEYCODE_KP9, 		KEYCODE_Right},
 {KEYCODE_Insert,     KEYCODE_LeftShift, KEYCODE_x, KEYCODE_v, KEYCODE_n, KEYCODE_Comma,        KEYCODE_Slash,        KEYCODE_Escape,		KEYCODE_KP1, 			KEYCODE_KP3, 		KEYCODE_128ScrollLock},
};
#else
static long kbdMatrixKeyCodes[8][8] = {
...
void CKernel::ScanKeyboard() {
  ...
  //Keyboard scan extra keys on C128
  if (intC128 == 1) {
    
    for (int kbdPA = 19; kbdPA < 22; kbdPA++) {
      ...
      for (int kbdPB = 0; kbdPB < 8; kbdPB++) {
        ...
        long keycode = kbdMatrixKeyCodes[kbdPB][kbdPA-11];
	      	
        if (val == LOW && kbdMatrixStates[kbdPA-11][kbdPB] == HIGH) {
          emu_key_pressed(keycode);
        } else if (val == HIGH && kbdMatrixStates[kbdPA-11][kbdPB] == LOW) {
          emu_key_released(keycode);
        }
        kbdMatrixStates[kbdPA-11][kbdPB] = val;
      }
