...
case "$arg" in
       ...
       --perf-stats)
              ...
              ;;
       *)
              echo "Need arg [pi0|pi2|pi3|pi4] [--skip-patches] [--kasan] [--io-stats] [--perf-stats]"
              exit 1
              ;;
esac
done
...
then
       ...
       VICE_PERF_CFLAGS="-DBMC64_PERF_STATS"
fi
