...
typedef enum {
   ...
   MENU_REU_ATTACH_IMAGE_FILE,
   MENU_REU_SAVE_IMAGE_AS_FILE,
   MENU_IDE64_IMAGE_1_FILE,
   MENU_IDE64_IMAGE_2_FILE,
   MENU_IDE64_IMAGE_3_FILE,
   MENU_IDE64_IMAGE_4_FILE,
   ...
   MENU_DRIVE_ROM_FILE_2000,
   MENU_DRIVE_ROM_FILE_4000,
   MENU_DRIVE_ROM_FILE_CMDHD,
   MENU_DRIVE_ROM_FILE_2031,
   MENU_DRIVE_ROM_FILE_2040,
   MENU_DRIVE_ROM_FILE_3040,
   MENU_DRIVE_ROM_FILE_4040,
   MENU_DRIVE_ROM_FILE_1001,
   ...
   MENU_DRIVE_CHANGE_ROM_2000,
   MENU_DRIVE_CHANGE_ROM_4000,
   MENU_DRIVE_CHANGE_ROM_CMDHD,
   MENU_DRIVE_CHANGE_ROM_2031,
   MENU_DRIVE_CHANGE_ROM_2040,
   MENU_DRIVE_CHANGE_ROM_3040,
   MENU_DRIVE_CHANGE_ROM_4040,
   MENU_DRIVE_CHANGE_ROM_1001,
   ...
   MENU_DPI_ENABLED,
   MENU_NETWORKING,
   MENU_NETWORK_ENABLED,
   MENU_NETWORK_MODEM_ADDRESS,
   MENU_TIMEZONE_OFFSET,
   MENU_WIFI_SSID,
   MENU_WIFI_PSK,
   MENU_WIFI_SECURITY,
   MENU_WIFI_COUNTRY,
   ...
   MENU_REU,
   MENU_REU_SIZE,
   MENU_REU_ATTACH_IMAGE,
   MENU_REU_DETACH_IMAGE,
   MENU_REU_IMAGE_WRITE,
   MENU_REU_SAVE_IMAGE,
   MENU_REU_SAVE_IMAGE_AS,
   MENU_IDE64_VERSION,
   MENU_IDE64_RTC_SAVE,
   MENU_IDE64_USB_SERVER,
   MENU_IDE64_USB_SERVER_ADDRESS,
   MENU_IDE64_IMAGE_1,
   MENU_IDE64_IMAGE_2,
   MENU_IDE64_IMAGE_3,
   MENU_IDE64_IMAGE_4,
   MENU_IDE64_AUTODETECT_1,
   MENU_IDE64_AUTODETECT_2,
   MENU_IDE64_AUTODETECT_3,
   MENU_IDE64_AUTODETECT_4,
   MENU_IDE64_CYLINDERS_1,
   MENU_IDE64_CYLINDERS_2,
   MENU_IDE64_CYLINDERS_3,
   MENU_IDE64_CYLINDERS_4,
   MENU_IDE64_HEADS_1,
   MENU_IDE64_HEADS_2,
   MENU_IDE64_HEADS_3,
   MENU_IDE64_HEADS_4,
