...
static APTR build_drive_gui(void)
{
    ...
    ui = GroupObject,
           ...
           FILENAME(ui_to_from_drive[3].object, "1551", hook_object_drive[3])
           FILENAME(ui_to_from_drive[4].object, "1570", hook_object_drive[4])
           FILENAME(ui_to_from_drive[5].object, "1571", hook_object_drive[5])
