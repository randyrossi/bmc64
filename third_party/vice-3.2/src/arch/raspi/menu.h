...
#define DIR_N_INDEX 0
#define DIR_NE_INDEX 1
#define DIR_E_INDEX 2
#define DIR_SE_INDEX 3
#define DIR_S_INDEX 4
#define DIR_SW_INDEX 5
#define DIR_W_INDEX 6
#define DIR_NW_INDEX 7
#define DIR_NEUTRAL_INDEX 8
