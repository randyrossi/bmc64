...
extern void cmdhd_setup_context(struct drive_context_s *drive_context);
extern void cmdhd_init(struct drive_context_s *drive_context);
extern void cmdhd_reset(struct cmdhd_context_s *ctxptr);
extern void cmdhd_reset_soft(drive_t *drv);

extern void cmdhd_store(struct drive_context_s *ctxptr, uint16_t addr, uint8_t byte);
extern uint8_t cmdhd_read(struct drive_context_s *ctxptr, uint16_t addr);
extern uint8_t cmdhd_peek(struct drive_context_s *ctxptr, uint16_t addr);
extern int cmdhd_dump(struct drive_context_s *ctxptr, uint16_t addr);
