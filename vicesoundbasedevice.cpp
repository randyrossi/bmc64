...
ViceSoundBaseDevice::~ViceSoundBaseDevice (void)
{
	assert (0);
}

int ViceSoundBaseDevice::GetRangeMin (void) const
{
	return -32768;
}

int ViceSoundBaseDevice::GetRangeMax (void) const
{
	return 32767;
}
...
void ViceSoundBaseDevice::SetControl (int nVolume, TVCHIQSoundDestination Destination)
{
...
void ViceSoundBaseDevice::Callback (const VCHI_CALLBACK_REASON_T Reason, void *hMessage)
{
...
void ViceSoundBaseDevice::CallbackStub (void *pParam, const VCHI_CALLBACK_REASON_T Reason,
					  void *hMessage)
{
